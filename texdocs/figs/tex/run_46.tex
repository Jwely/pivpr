...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_46/run_46_stream}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_46/run_46_T_vs_r_mesh_ctkescatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_46/run_46_ctke_vs_r_meshscatter}
