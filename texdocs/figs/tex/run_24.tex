...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_24/run_24_turb_visc_reynolds_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_24/run_24_turb_visc_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_24/run_24_nut_tot_fit}
\caption{Polynomial fits of reynolds stress and velocity gradient terms at $z/c$=7.75, $V_{free}$=21.09, station 3.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_24/run_24_momentum_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_24/run_24_turb_visc_total_vs_r_meshscatter}
