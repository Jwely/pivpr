...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_67/run_67_turb_visc_ettap_top_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_67/run_67_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
