...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_12/run_12_turb_visc_reynolds_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_12/run_12_turb_visc_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_12/run_12_nut_tot_fit}
\caption{Polynomial fits of reynolds stress and velocity gradient terms at $z/c$=6.97, $V_{free}$=16.89, station 2.}
\end{figure}
