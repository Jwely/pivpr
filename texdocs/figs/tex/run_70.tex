...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_70/run_70_stream}
\caption{Stream plot at $z/c$=10.00, $V_{free}$=33.01, station 7.}
\label{fig:run_70_stream}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_70/run_70_R_contour}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_70/run_70_W_contour}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_70/run_70_rw_contour}
...
\label{fig:run_70_num_contour}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_70/run_70_T_vs_r_meshscatter}
\caption{Scatter plot of azimuthal velocity vs radius at $z/c$=10.00, $V_{free}$=33.01, station7.}
\label{fig:run_70_T_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_70_T_vs_r_mesh_ctkescatter}
\end{figure}
...
\label{fig:run_70_turb_visc_ettap_top_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_70/run_70_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ velocity gradient term vs radius at $z/c$=10.00, $V_{free}$=33.01, station 7.}
\label{fig:run_70_turb_visc_ettap_bot_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_70/run_70_turb_visc_ettap_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ pressure relaxation term vs radius at $z/c$=10.00, $V_{free}$=33.01, station 7.}
\label{fig:run_70_turb_visc_ettap_vs_r_meshscatter}
\end{figure}
