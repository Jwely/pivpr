...
\label{fig:run_62_comparison}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_62/run_62_stream}
\caption{Stream plot at $z/c$=10.00, $V_{free}$=16.98, station 7.}
\label{fig:run_62_stream}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_62/run_62_rw_contour}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_62/run_62_tw_contour}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_62/run_62_rr_contour}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.25in]{figs/run_62/run_62_ctke_contour}
\caption{Contour plot of $k$ at $z/c$=10.00, $V_{free}$=16.98, station 7.}
\label{fig:run_62_ctke_contour}
\end{figure}
...
\label{fig:run_62_T_vs_r_mesh_ctkescatter}
\end{figure}
...
\label{fig:run_62_ctke_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_62/run_62_turb_visc_ettap_top_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ reynolds stress term vs radius at $z/c$=10.00, $V_{free}$=16.98, station 7.}
\label{fig:run_62_turb_visc_ettap_top_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_62_turb_visc_ettap_bot_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_62_turb_visc_ettap_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_62_ctke_01rdynamic}
\end{figure}
