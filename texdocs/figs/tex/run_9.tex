...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_9/run_9_turb_visc_by_vtheta_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_9/run_9_momentum_vel_grad_vs_r_meshscatter}
