...
\label{fig:run_58_T_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_58_T_vs_r_mesh_ctkescatter}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_58/run_58_turb_visc_ettap_top_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ reynolds stress term vs radius at $z/c$=9.50, $V_{free}$=29.17, station 6.}
\label{fig:run_58_turb_visc_ettap_top_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_58/run_58_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ velocity gradient term vs radius at $z/c$=9.50, $V_{free}$=29.17, station 6.}
\label{fig:run_58_turb_visc_ettap_bot_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_58_ctke_12rdynamic}
\end{figure}
