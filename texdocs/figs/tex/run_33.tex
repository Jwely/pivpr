...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_33/run_33_turb_visc_reynolds_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_33/run_33_turb_visc_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_33/run_33_nut_tot_fit}
\caption{Polynomial fits of reynolds stress and velocity gradient terms at $z/c$=8.50, $V_{free}$=19.08, station 4.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_33/run_33_turb_visc_total_vs_r_meshscatter}
