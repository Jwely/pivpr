...
\label{fig:run_47_turb_visc_ettap_top_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_47/run_47_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ velocity gradient term vs radius at $z/c$=9.00, $V_{free}$=27.08, station 5.}
\label{fig:run_47_turb_visc_ettap_bot_vs_r_meshscatter}
\end{figure}
...
\label{fig:run_47_turb_visc_ettap_vs_r_meshscatter}
\end{figure}
