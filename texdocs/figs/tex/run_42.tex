...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_42/run_42_turb_visc_reynolds_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_42/run_42_turb_visc_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_42/run_42_nut_tot_fit}
\caption{Polynomial fits of reynolds stress and velocity gradient terms at $z/c$=9.00, $V_{free}$=17.24, station 5.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_42/run_42_momentum_vel_grad_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_42/run_42_turb_visc_total_vs_r_meshscatter}
