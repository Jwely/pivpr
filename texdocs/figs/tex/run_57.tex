...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_57/run_57_turb_visc_ettap_top_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_57/run_57_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
