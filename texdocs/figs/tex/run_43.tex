...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_43/run_43_nut_ratio_fit}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_43/run_43_nut_tot_fit}
\caption{Polynomial fits of reynolds stress and velocity gradient terms at $z/c$=9.00, $V_{free}$=19.08, station 5.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_43/run_43_momentum_vel_grad_vs_r_meshscatter}
