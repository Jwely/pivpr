...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_55/run_55_turb_visc_by_vtheta_vs_r_meshscatter}
...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_55/run_55_momentum_vel_grad_vs_r_meshscatter}
