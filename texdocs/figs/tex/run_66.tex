...
\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_66/run_66_turb_visc_ettap_top_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ reynolds stress term vs radius at $z/c$=10.00, $V_{free}$=24.96, station 7.}
\label{fig:run_66_turb_visc_ettap_top_vs_r_meshscatter}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=6in]{figs/run_66/run_66_turb_visc_ettap_bot_vs_r_meshscatter}
\caption{Scatter plot of $
u_T$ velocity gradient term vs radius at $z/c$=10.00, $V_{free}$=24.96, station 7.}
\label{fig:run_66_turb_visc_ettap_bot_vs_r_meshscatter}
\end{figure}
