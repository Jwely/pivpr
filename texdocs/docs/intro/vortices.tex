...
laminarizes the vortex \cite{ragab1994}. Organized motions surrounding the core 
...
turbulence to wrap around a columnar vortex in axisymmetric loops.


The turbulent structure of an axial vortex may depend upon local atmospheric 
conditions, and can influence the rate at which a vortex decays, and has 
significant implications on aviation safety. Direct Numerical Simulation (DNS) 
has been performed to demonstrate that constant eddy viscosity models can be 
used to assess the influence of surface weather conditions on wake vortex 
decay \cite{ash1998}.



The turbulent structure of axial vortices 
using a bi-wing vortex generator has 
been shown to be independent of free stream turbulence \cite{bandyopadhyay1991}.
