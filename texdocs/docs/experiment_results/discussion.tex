...
Viscosity was calculated from the mean azimuthal velocity and 
observed to be nearly constant as expected, especially outside of 0.5 
core radii as shown for an example set in Figure 
\ref{fig:run_55_turb_visc_by_vtheta_vs_r_meshscatter} where $\eta_P = 0.39 \mu 
s$,  $v_{\theta, max} = 5.5 m/s$, and $\nu$ cane be estimated to be constant at 
\num{5.9e-6}.
