...
\subsection{Pressure Gradients}

Pressure measurements are challenging to acquire concurrently with PIV 
measurements, and were not included in this study. However, non-equilibrium 
pressure theory relates the radial pressure gradient to the velocity gradient 
via
