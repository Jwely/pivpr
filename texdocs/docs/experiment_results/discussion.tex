...
nature, but is subject to significant noise. The final result of turbulent 
viscosity by combining all the terms as in Equation \ref{eq:etap_nut} was found 
to reflect a very significant radial dependence in turbulent energy dissipation 
as indicated by the turbulent viscosity as shown in Figure 
\ref{fig:run_55_turb_visc_total_vs_r_meshscatter}. Within one and a half core 
radii, the turbulent viscosity departs from near zero and moves upwards. It was 
at the same 1.5 core radii boundary that the classical turbulent viscosity 
hypothesis began to demonstrate a significant reduction in variance. Though 
both models show changes occurring in similar radial zones, no further 
relationship was found between them.

\input{figs/run_55/run_55_turb_visc_total_vs_r_meshscatter}


These trends in turbulent viscosity shown above remain generally consistent 
over all velocities and stations. By calculating the turbulent viscosity 
implicit in the non-equilibrium pressure solution for an axial wake vortex, it 
was demonstrated that the theory predicts a very significant increase in the 
rate of turbulent kinetic energy dissipation in the core region of an axial 
vortex. The predicted dissipation rate within the core was found to be up to 
two orders of magnitude larger than is estimated by the standard turbulent 
