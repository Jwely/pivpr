...
The final result of turbulent viscosity by combining all the terms as in 
Equation \ref{eq:etap_nut} was found to reflect a very significant radial 
dependence in turbulent energy dissipation as indicated by the turbulent 
viscosity as shown in Figure \ref{fig:run_55_turb_visc_total_vs_r_meshscatter}.
