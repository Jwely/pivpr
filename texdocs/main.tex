...
% magical packages
\documentclass[12pt, openany]{report}	% defines the type of document this is
...
\usepackage[all]{nowidow} 	% prevents orphaned headers
...
\degrees{B.S.M.E. 2011, Old Dominion University}
\dept{Aerospace Engineering}
\submitdate{May 2016}
\vita{Bachelors of Science, Mechanical Engineering, Old Dominion University, 
December 2011}
...
\abstract{
	...
	Ash, Zardadkhan and Zuckerwar \cite{ash2011}, and tests specific attributes 
...
%attempted by use of git version control software and a git repository. All 
%%%code 
...
\input{docs/experiment_setup/setup_intro}
